$(document).ready(function () {
    ...
    document.getElementById('sendQuotationForm').addEventListener('input', function () {
        const nameTo = document.querySelector('input[name="nameTo"]').value.trim();
        const emailTo = document.querySelector('input[name="emailTo"]').value.trim();
        const submitButton = document.querySelector('button[type="submit"]');
        submitButton.disabled = !nameTo || !emailTo;
    });
});
