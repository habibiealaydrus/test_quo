...
<div class="row">
    ...
    <div class="card card-action mb-5">
        <div class="card-header header-elements">
            <span class="me-2 btn btn-sm btn-success rounded-pill waves-effect waves-light">Sell Quotation</span>
        ...
        <form id="addNewQuotationForm" action="{{ url('/quotation/store') }}" method="POST" onsubmit="return false">
            @csrf
